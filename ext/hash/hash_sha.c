...
PHP_HASH_API void PHP_SHA384Init(PHP_SHA384_CTX * context)
{
	...
	/* Load magic initialization constants.
	 */
	context->state[0] = UINT64_C(0xcbbb9d5dc1059ed8);
	context->state[1] = UINT64_C(0x629a292a367cd507);
	context->state[2] = UINT64_C(0x9159015a3070dd17);
	context->state[3] = UINT64_C(0x152fecd8f70e5939);
	context->state[4] = UINT64_C(0x67332667ffc00b31);
	context->state[5] = UINT64_C(0x8eb44a8768581511);
	context->state[6] = UINT64_C(0xdb0c2e0d64f98fa7);
	context->state[7] = UINT64_C(0x47b5481dbefa4fa4);
}
/* }}} */
...
PHP_HASH_API void PHP_SHA512_256Init(PHP_SHA512_CTX * context)
{
	...
	context->state[0] = UINT64_C(0x22312194FC2BF72C);
	context->state[1] = UINT64_C(0x9F555FA3C84C64C2);
	context->state[2] = UINT64_C(0x2393B86B6F53B151);
	context->state[3] = UINT64_C(0x963877195940EABD);
	context->state[4] = UINT64_C(0x96283EE2A88EFFE3);
	context->state[5] = UINT64_C(0xBE5E1E2553863992);
	context->state[6] = UINT64_C(0x2B0199FC2C85B8AA);
	context->state[7] = UINT64_C(0x0EB72DDC81C52CA2);
}
/* }}} */
...
PHP_HASH_API void PHP_SHA512_224Init(PHP_SHA512_CTX * context)
{
	...
	context->state[0] = UINT64_C(0x8C3D37C819544DA2);
	context->state[1] = UINT64_C(0x73E1996689DCD4D6);
	context->state[2] = UINT64_C(0x1DFAB7AE32FF9C82);
	context->state[3] = UINT64_C(0x679DD514582F9FCF);
	context->state[4] = UINT64_C(0x0F6D2B697BD44DA8);
	context->state[5] = UINT64_C(0x77E36F7304C48942);
	context->state[6] = UINT64_C(0x3F9D85A86A1D36C8);
	context->state[7] = UINT64_C(0x1112E6AD91D692A1);
}
/* }}} */
